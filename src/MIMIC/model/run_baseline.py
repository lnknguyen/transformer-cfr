...
data_dir = "/scratch/work/luongn1/transformer-cfr/data/mimic/processed/sequential_mimic.csv"
x_diag, x_age, gender, t, y0, y1, yf = make_cfr_mimic(data_dir,
                                                      beta0 = 1.0,
                                                      beta1 = 25.0,
                                                      gamma = 1.0,
                                                      setting = "binary")
...
#print(x_age.shape)
#print(gender.shape)
#X = np.hstack((x_diag, x_age, gender))

X = x_diag.reshape(no, -1)
print(X.shape)
